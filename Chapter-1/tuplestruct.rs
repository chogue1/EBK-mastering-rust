...
// temperature1.0 represents the 1st position of the tuple in the struct

// this code can't compile because the two temperatures are different types being compared on
// line 12/13.
